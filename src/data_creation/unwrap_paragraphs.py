...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", type=str, default=None, help="Input .txt file. If not provided, the input is expected through stdin"
    )
    parser.add_argument(
        "--output", type=str, default=None, help="Output .txt file. If not provided, the output is printed to stdout"
    )
    parser.add_argument(
        "--paragraph_del_len", type=str, default=3, help="Number of empty lines that represent a paragraph delimitation"
    )
